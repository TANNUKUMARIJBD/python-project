...
HeadingLabel = tkinter.Label(root, text="Hello users!",
   fg = "light green",
     bg = "dark green",
...
button = tkinter.Button(root, text='click the Dice', fg='blue', command=rolling_dice)
